...
(
    id          bigint unsigned NOT NULL AUTO_INCREMENT COMMENT '主链',
    template_id bigint unsigned NOT NULL COMMENT '消息模板ID',
    type        int             NOT NULL DEFAULT 1 COMMENT '推送渠道 1短信 2邮件 3微信 4APP',
    receiver    varchar(128)    NOT NULL DEFAULT '' COMMENT '消息接收者（手机号，邮霜号，微信openid等）',
  ...
  COLLATE = utf8mb40900ai_ci COMMENT = '消息推送记录表';
```
...
![image-20220801144601166](01_web 实现消息推送/image-20220801144601166.png)
...
![iframe](01_web 实现消息推送/iframe.gif)
...
![image-20220801144930356](01_web 实现消息推送/image-20220801144930356.png)

整体的实现思路有点类似于在线视频播放，视频流会连续不断的推送到浏览器，你也可以理解成，客户端在完成一次用时很长（网络不畅）的下载。

![image-20220801145119790](01_web 实现消息推送/image-20220801145119790.png)
...
![sse](01_web 实现消息推送/sse.gif)

**注意：** SSE不支持`IE`浏览器，对其他主流浏览器兼容性做的还不错。

![image-20220801145845858](01_web 实现消息推送/image-20220801145845858.png)
...
![image-20220801150008536](01_web 实现消息推送/image-20220801150008536.png)
...
![image-20220801150340967](01_web 实现消息推送/image-20220801150340967.png)
...
![image-20220801150613581](01_web 实现消息推送/image-20220801150613581.png)

![websocket](01_web 实现消息推送/websocket.gif)
...
![image-20220801150857098](01_web 实现消息推送/image-20220801150857098.png)
