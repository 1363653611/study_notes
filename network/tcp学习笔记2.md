...
TCP要解决一个很大的事，那就是要在一个网络根据不同的情况来动态调整自己的发包的速度，小则让自己的连接更稳定，大则让整个网络更稳定。本篇文章有好些算法和策略，可能会引发各种思考，让你的大脑分配很多内存和计算资源。
...
- 短了，会导致可能并没有丢就重发。于是重发的就快，会增加网络拥塞，导致更多的超时，更多的超时导致更多的重发。
...
![img](tcp学习笔记2/Karn-Partridge-Algorithm.jpg)
...
![img](tcp学习笔记2/sliding_window.jpg)
...
![img](tcp学习笔记2/tcpswslide.png)

下面我们来看一个接受端控制发送端的图示：

![img](tcp学习笔记2/tcpswflow.png)
...
![img](tcp学习笔记2/tcp.slow_.start_.jpg)
...
![img](tcp学习笔记2/tcp.fr_-1024x359.jpg)
...
![img](tcp学习笔记2/tcp_vegas_newreno-1024x555-8798215.jpg)
