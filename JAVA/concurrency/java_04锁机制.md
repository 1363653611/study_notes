...
|超时获取锁|在指定时间之前获取到锁，如果截止时间到了，仍然获取不到锁，则返回|
...
![image-20201104170220653](java_04锁机制/image-20201104170220653.png)
...
![image-20201104184752865](java_04锁机制/image-20201104184752865.png)
...
>
>![image-20201104185027042](java_04锁机制/image-20201104185027042.png)
...
而LockSupport也成为构建同步组件的基础工具。LockSupport定义了一组以park开头的方法用来阻塞当前线程，以及unpark(Thread thread)方法来唤醒一个被阻塞的线程。Park有停车的意思，假设线程为车辆，那么park方法代表着停车，而unpark方法则是指车辆启动离开，
