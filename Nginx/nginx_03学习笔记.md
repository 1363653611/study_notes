...
![image-20210423154247448](Untitled/image-20210423154247448.png)
...
![image-20210423174914116](Untitled/image-20210423174914116.png)
...
这样划分是为了使得每个模块的功能相对简单，便于开发，同时也便于对系统进行功能扩展。`Nginx` 的模块是互相独立的,低耦合高内聚。
